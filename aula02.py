...
# Função que exibe uma mensagem e espera um imput do usuário, termidado por Enter
# Output SEMPRE vai ser uma string


# === COMENTÁRIOS ===============================

# Este é um comentário com uma linha, que começa com um hashtag

'''
Este é um comentário
usando mais de uma linha.
Ele começa com três aspas
e termina com três aspas
'''
...
# ele deverá fornecer o valor constante da aplicação mensal, a taxa e o número de meses. 
...
# Elabore um algoritmo que solicite por quatro notas ao usuário. Em seguida, calcule 
# e apresente na tela a média aritmética destas notas.
...
# Elabore um algoritmo que solicite três notas ao usuário. Depois disso, calcule a média
# ponderada das notas informadas, sabendo-se que os pesos são 2, 3, 5, respectivamente. 
...
# Um viajante gostaria de um aplicativo que o auxiliasse a fazer a conversão dos preços de hotéis 
# que ele reserva, que geralmente estão em dólares americanos, para reais. Auxilie no 
# desenvolvimento deste aplicativo desenvolvendo um algoritmo que solicite o valor da diária do 
# quarto, a quantia de diárias que o viajante irá ficar neste hotel e o valor do dólar do dia da reserva. 
# Em seguida, calcule e apresente a quantia de reais que este viajante irá precisar para esta reserva.
...
# uma pesquisa na Internet, ele descobriu que aqui utilizamos a temperatura em graus 
# Celsius. Para isso, este turista precisa de um processo automatizado para simplificar
# a conversão entre estas temperaturas. Com isto, ele poderá saber qual tipo de roupa 
# deverá trazer em suas próximas férias.
# Você, como estudante de algoritmos, pode auxiliar este turista desenvolvendo 
# um algoritmo que solicite uma temperatura em graus Fahrenheit e a converta para Celsius, 
# apresentando o resultado na tela. Desenvolva este algoritmo.
