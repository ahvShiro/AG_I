...
# Contexto: Uma loja de eletrônicos possui um sistema de controle de estoque onde cada produto tem um código, uma quantidade em estoque e um preço unitário. O gerente quer saber o valor total em estoque para cada produto.
...
# Contexto: Uma estação meteorológica registra as temperaturas médias diárias de diferentes cidades. O analista quer saber quantos dias a temperatura foi superior a uma certa referência em cada cidade.
...
# Contexto: Uma empresa quer saber qual é o salário médio dos seus funcionários e identificar os funcionários que ganham acima da média.
...
# Contexto: Um e-commerce deseja analisar o total de vendas por categoria de produto. Para isso, ele possui uma lista com o valor de cada venda e outra lista com a categoria do produto vendido. O gerente quer calcular o total de vendas de cada categoria.
